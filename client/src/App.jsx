  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "30px", marginBottom: "40px" }}>
        <GaugeCard title="Voltage" value={data.vrms} unit="V" min={0} max={460} color="#3b82f6" peakMin={data.peaks?.v_min} peakMax={data.peaks?.v_max}/>
        ...
        <GaugeCard title="Active Power" value={data.power} unit="W" min={0} max={2600} color="#f59e0b" peakMax={data.peaks?.p_max} />
        <GaugeCard title="Total Energy" value={data.energy} unit="kWh" min={0} max={150} color="#8b5cf6" />
      </div>
